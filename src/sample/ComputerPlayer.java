...
//            double dleft=ComputeMaximumLength(x,y,alpha-Math.PI/15,0);
//            double d=ComputeMaximumLength(x,y,alpha,0);
//            double dright=ComputeMaximumLength(x,y,alpha+Math.PI/15,0);
//            if(dleft>d && dleft > dright){LeftTurnStack=1;}
//            else if(dright>d){RightTurnStack=1;}
        }
    }
